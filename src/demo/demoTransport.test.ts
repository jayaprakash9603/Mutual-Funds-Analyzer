...
import { filterCompareResults, filterDemoSchemes } from '@/demo/demoFilters'
import { resetDemoManifestCache, type DemoManifest } from '@/demo/demoManifest'
import { fetchDemoJson, hasDemoHandler } from '@/demo/demoTransport'
...
const fixtures: Record<string, unknown> = {
  ...
  'fund-report/alpha.json': { profile: { fundName: ALPHA } },
...
describe('demoTransport routing', () => {
  ...
  it('serves peers and the fund vs index matrix', async () => {
