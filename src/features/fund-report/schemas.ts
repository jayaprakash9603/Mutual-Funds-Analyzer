...
export const fundReportSchema = z.object({
  ...
  volatility: z.object({
    ...
    periods: z.array(z.object({
      ...
      stdDevPercent: z.number(),
      annualisedVolatilityPercent: z.number(),
      averageReturnPercent: z.number(),
      typicalSwingPercent: z.number(),
      bestReturnPercent: z.number(),
      bestReturnDate: z.string(),
      worstReturnPercent: z.number(),
      worstReturnDate: z.string(),
      positivePeriodsPercent: z.number(),
      negativePeriodsPercent: z.number(),
      benchmarkAnnualisedVolatilityPercent: z.number(),
      benchmarkBestReturnPercent: z.number(),
      benchmarkWorstReturnPercent: z.number(),
    })),
    rollingSeries: z.array(z.object({
      date: z.string(),
      fundVolatilityPercent: z.number(),
      benchmarkVolatilityPercent: z.number(),
    })),
    rollingSummary: z.object({
      ...
      minPercent: z.number(),
      minDate: z.string(),
      benchmarkAveragePercent: z.number(),
      timeAboveBenchmarkPercent: z.number(),
    }),
    dailyDistribution: z.array(z.object({
      label: z.string(),
      lowerPercent: z.preprocess(coerceNumericBound, z.number()),
      upperPercent: z.preprocess(coerceNumericBound, z.number()),
      count: z.number(),
