...
@Entity
@Table(
        name = "fund_report_section_snapshot",
        uniqueConstraints = @UniqueConstraint(columnNames = {"scheme", "start_date", "section_group"}))
public class FundReportSectionSnapshotEntity implements FundReportSectionSnapshotRecord {
    ...
    @Column(name = "section_group", nullable = false, length = 32)
