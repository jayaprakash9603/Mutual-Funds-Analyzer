...
CREATE TABLE rolling_aggregate (
    ...
    fund_mean DOUBLE PRECISION NOT NULL DEFAULT 0,
    fund_m2 DOUBLE PRECISION NOT NULL DEFAULT 0,
    fund_min DOUBLE PRECISION NOT NULL DEFAULT 0,
    fund_max DOUBLE PRECISION NOT NULL DEFAULT 0,
    index_count BIGINT NOT NULL DEFAULT 0,
    index_mean DOUBLE PRECISION NOT NULL DEFAULT 0,
    index_m2 DOUBLE PRECISION NOT NULL DEFAULT 0,
    index_min DOUBLE PRECISION NOT NULL DEFAULT 0,
    index_max DOUBLE PRECISION NOT NULL DEFAULT 0,
